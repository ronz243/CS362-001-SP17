...
public class TimeTableTest {
    ...
    public void test11(){
        TimeTable timeTable1 = new TimeTable();
        LinkedList<Appt>appts = new LinkedList<Appt>();
        Appt appt = new Appt(12,10,3,4,2016,"bobo","need to go");
        appts.add(appt);
        Appt appt2 = new Appt(10,10,3,4,2016,"bobo","need to go");
    ...
    public void test13(){
        TimeTable timeTable1 = new TimeTable();
        LinkedList<Appt> appts = new LinkedList<Appt>();
        Appt appt1 = new Appt( 1,10,3,4,2016,"bobo","need to go");
        Appt appt2 = new Appt(10,10,3,4,2016,"boeing","need to build");
        appts.add(appt1);
        appts.add(appt2);
        GregorianCalendar gregOne = new GregorianCalendar(2016,4,3);
        GregorianCalendar gregTwo = new GregorianCalendar(2016,5,4);
    ...
    public void test14(){
        TimeTable timeTable1 = new TimeTable();
        LinkedList<Appt> appts = new LinkedList<Appt>();
        Appt appt1 = new Appt( 1,10,2,3,2016,"bobo","need to go");
        Appt appt2 = new Appt(10,10,3,4,2016,"boeing","need to build");
        appts.add(appt1);
        appts.add(appt2);
        GregorianCalendar gregOne = new GregorianCalendar(2016,4,3);
    ...
    public void test15(){
        TimeTable timeTable1 = new TimeTable();
        LinkedList<Appt> appts = new LinkedList<Appt>();
        Appt appt1 = new Appt( 1,10,2,6,2017,"bobo","need to go");
        Appt appt2 = new Appt(10,10,3,4,2016,"boeing","need to build");
        appts.add(appt1);
        appts.add(appt2);
        GregorianCalendar gregOne = new GregorianCalendar(2016,4,3);
    ...
    public void test16(){
        TimeTable timeTable1 = new TimeTable();
        LinkedList<Appt> appts = new LinkedList<Appt>();
        Appt appt1 = new Appt( 1,10,2,6,2016,"bobo","need to go");
        Appt appt2 = new Appt(10,10,3,4,2016,"boeing","need to build");
        appts.add(appt1);
        appts.add(appt2);
    ...
    public void test17(){
        ...
        GregorianCalendar gregTwo = new GregorianCalendar(2016,5,4);
        //LinkedList<GregorianCalendar>calendars = new LinkedList<GregorianCalendar>();
        try {
            assertNotNull(timeTable1.getApptRange(appts,gregOne,gregTwo));
        }catch (IllegalArgumentException e){
            e.printStackTrace();
